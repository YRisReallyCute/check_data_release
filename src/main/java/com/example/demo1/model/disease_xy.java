...
//        getInfo_mcjs().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_bm().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_bybj().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_bzsz().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_dfrq().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_fbbw().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_fj().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_fk().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_hl().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_jbzd().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_lcbx().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_qt().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_tnlf().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_wfwz().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_yfbj().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_yh().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_yslf().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_ywmc().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_zjlf().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
//        getInfo_zybm().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1);
        ...
        setInfo_zybm(getInfo_zybm().replaceAll("<h1>",str1_0).replaceAll("</h1>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2>",str2_1));
