...
@Entity
@Table(name="data_disease_xy_zgyyxxcxpt")
public class disease_xy {
    @Id
    @GeneratedValue
    private Integer id;
    ...
    public disease_xy replaceStr(ReplaceLabels replaceLabels){
//  jq 注
...
// yr注
//        getInfo_mcjs().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_bm().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_bybj().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_bzsz().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_dfrq().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_fbbw().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_fj().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_fk().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_hl().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_jbzd().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_lcbx().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_qt().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_tnlf().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_wfwz().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_yfbj().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_yh().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_yslf().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_ywmc().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_zjlf().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
//        getInfo_zybm().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
...
//        setInfo_zybm(getInfo_zybm().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1).replaceAll("<!--.*-->", "").replaceAll("<(?=[0-9])","小于"));
        ...
        setInfo_bybj(replaceLabels.rep(replaceLabels, getInfo_bybj()));
        setInfo_bzsz(replaceLabels.rep(replaceLabels, getInfo_bzsz()));
        setInfo_dfrq(replaceLabels.rep(replaceLabels, getInfo_dfrq()));
        setInfo_fbbw(replaceLabels.rep(replaceLabels, getInfo_fbbw()));
        setInfo_fj(replaceLabels.rep(replaceLabels, getInfo_fj()));
        setInfo_fk(replaceLabels.rep(replaceLabels, getInfo_fk()));
        setInfo_hl(replaceLabels.rep(replaceLabels, getInfo_hl()));
        setInfo_jbzd(replaceLabels.rep(replaceLabels, getInfo_jbzd()));
        setInfo_lcbx(replaceLabels.rep(replaceLabels, getInfo_lcbx()));
        setInfo_qt(replaceLabels.rep(replaceLabels, getInfo_qt()));
        setInfo_tnlf(replaceLabels.rep(replaceLabels, getInfo_tnlf()));
        setInfo_wfwz(replaceLabels.rep(replaceLabels, getInfo_wfwz()));
        setInfo_yfbj(replaceLabels.rep(replaceLabels, getInfo_yfbj()));
        setInfo_yh(replaceLabels.rep(replaceLabels, getInfo_yh()));
