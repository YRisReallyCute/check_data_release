...
//        getInfo_zybm().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1);
        ...
        setInfo_zybm(getInfo_zybm().replaceAll("<h1>",str1_0).replaceAll("</h1><br/>",str1_1).replaceAll("<h2>",str2_0).replaceAll("</h2><br/>",str2_1).replaceAll("<!--.*-->", "").replaceAll("<(?=[0-9])","小于").replaceAll(">(?=[0-9])","大于"));
